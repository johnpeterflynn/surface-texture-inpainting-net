...
class SemSegVisualizer:
    ...
    def visualize_result(self, mesh_name, prediction=None, gt=None):
        ...
        if type(prediction) == torch.Tensor:
            ...
            pred_colors = open3d.utility.Vector3dVector(
        ...
        if type(gt) == torch.Tensor:
            ...
            gt_colors = open3d.utility.Vector3dVector(self._dataset.color_map[gt.long()] / 255.)
        ...
        if type(gt) == torch.Tensor and type(prediction) == torch.Tensor:
            ...
            differences = pos + neg
            diff_colors = open3d.utility.Vector3dVector(
