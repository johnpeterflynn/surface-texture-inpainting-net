...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', dilation_order=0, use_dropout=False, init_type='normal',
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6,
                 dilation_order=0, padding_type='reflect'):
        ...
        for i in range(n_blocks):       # add ResNet blocks
            ...
            model += [ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
                                  use_bias=use_bias, dilation=dilation)]
...
class ResnetBlock(nn.Module):
    ...
    def build_conv_block(self, dim, padding_type, norm_layer, use_dropout, use_bias, dilation):
        ...
        conv_block += [nn.Conv2d(dim, dim, kernel_size=3, padding=p, dilation=dilation, bias=use_bias), norm_layer(dim), nn.ReLU(True)]
        if use_dropout:
